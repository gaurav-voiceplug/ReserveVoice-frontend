						...
						<div className="p-6 flex-1 overflow-y-auto space-y-6">
							<div className="flex items-start justify-between">
								<div>
									...
									<p className="text-xs text-[#505795] uppercase tracking-widest mt-1">{selected.id}</p>
								</div>
							...
							<div className="w-full min-w-0 mb-3">
								...
								<div className="flex flex-col border border-[#e8e9f3] rounded-lg pt-6 p-3">
									<div className="flex items-center gap-3">
										...
										<div className={`flex-1 h-2 rounded-full cursor-pointer overflow-hidden ${audioSrc ? 'bg-blue-50' : 'bg-gray-100'}`} onClick={(e) => {
											if (!audioSrc) return;
							...
							<div className="py-2 border-b border-[#e8e9f3]">
								<h4 className="font-semibold text-sm text-[#0e101b] mb-2">Details</h4>
								<ul className="space-y-2 text-sm text-[#505795]">
									<li><strong>Party:</strong> {selected.party}</li>
